...
public class WekaClassifier implements IClassifier, Serializable {
        ...
        public WekaClassifier() throws Exception {
                DataSource source_train = new DataSource("/home/sandeep/workspace/Replabeclipse/src/files/train1.arff");
                DataSource source_test = new DataSource("/home/sandeep/workspace/Replabeclipse/src/files/test1.arff");
        ...
        public String classify(String stringa) throws FileNotFoundException,
                ...
                // set class attribute
                unlabeled.setClassIndex(0);//changing
                ...
                return labeled.instance(0).stringValue(0);//changing
        }
